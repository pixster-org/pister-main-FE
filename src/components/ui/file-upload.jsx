        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="relative w-full mt-10 max-w-xl mx-auto">
            {files.length > 0 && (
                ...
                className="relative overflow-hidden z-40 flex flex-col items-start justify-start p-4 mt-4 w-full mx-auto rounded-md shadow-sm">
                <img
                ...
                <button
                  ...
                  className="w-full mt-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded transition-all"
                >
                  Upload
                </button>
              </motion.div>
